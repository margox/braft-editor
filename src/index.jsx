...
export default class BraftEditor extends EditorController {
  ...
  render() {
    ...
    let {
      ...
      fontSizes, fontFamilies, emojis, viewWrapper, placeholder, imageControls, lineHeights, textAlignMaps, needTextBgcolor
    } = this.props
    ...
    const controlBarProps = {
      ...
      colors, tempColors, fontSizes, fontFamilies, emojis, lineHeights, textAlignMaps, needTextBgcolor
    }
